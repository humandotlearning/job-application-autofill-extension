...
- `answerRecords`, application drafts, correction history, cover-message templates, datasource metadata, and the OpenAI API key are stored in `chrome.storage.local`.
